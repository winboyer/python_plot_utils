...
print('X_all_scaled===========', X_all_scaled.scale_, X_all_scaled.mean_, X_all_scaled.var_)
...
# pickled_model = joblib.load('mlp_train_model_lisan_12-17_iter4w_v1.pkl')
# pickled_model = joblib.load('mlp_train_model_lisan_12-17_ft11_iter4w_v1.pkl')
# pickled_model = joblib.load('mlp_train_model_lisan_all_v2.pkl')
# clf = pickled_model.fit(X_train_scaled, y_train)

# dump(clf, "mlp_train_model_lisan_12-17_ft7_iter4w_v3.pkl")
# dump(clf, "mlp_train_model_lisan_12-17_ft7524_iter4w.pkl") #v1表示正常finetune, v2表示finetune部分为0的数据
# dump(clf, "mlp_train_model_lisan_7-17_ft7524_iter4w.pkl")
dump(clf, "mlp_train_model_lisan_12-17_ft7524-6011_iter4w_v1.pkl")
# dump(clf, "mlp_train_model_lisan_7-17_ft6011_iter1w.pkl")
