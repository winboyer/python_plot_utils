...
mlp = MLPClassifier(solver='lbfgs', hidden_layer_sizes=(80, 40), alpha=1e-5, max_iter=40000, shuffle=True)
...
# joblib.dump(clf, "mlp_train_model_lisan_12-17_iter4w_v2.pkl")
...
y_train_pred = pickled_model.predict(X_train_scaled)
...
train_score = pickled_model.score(X_train_scaled, y_train)
test_score = pickled_model.score(X_test_scaled, y_test)
